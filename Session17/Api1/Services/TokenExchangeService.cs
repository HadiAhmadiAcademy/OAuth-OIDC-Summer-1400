...
namespace Api1.Services
{
    ...
    {
        public static async Task<TokenResponse> ExchangeForImpersonation(string token)
        {
        ...
        public static async Task<TokenResponse> ExchangeForDelegation(string subjectToken, string actorToken)
        {
            var requestBody = new StringBuilder()
                .Append("grant_type=urn%3Aietf%3Aparams%3Aoauth%3Agrant-type%3Atoken-exchange")
                ...
                .Append("&actor_token_type=urn%3Aietf%3Aparams%3Aoauth%3Atoken-type%3Aaccess_token")
                .ToString();
